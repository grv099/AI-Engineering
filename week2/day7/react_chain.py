...
#tools to be used in the chain. You can add more tools as per your requirement. The tools should be defined as functions and added to the tools dictionary.
...
def run_agent(question):
    ...
    for step in range(5):
        ...
        # Find the Action
        match = re.search(
            r"Action:\s*(\w+)\((.*?)\)", #regular expression to find the action and its argument
            answer
        )
